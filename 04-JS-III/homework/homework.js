...
function diaDeLaSemana(numeroDeDia) {
  ...
  //Escribe tu código aquí  
  var semana = ['Es fin de semana', 'Es dia Laboral']
 
  if (numeroDeDia === 1 || numeroDeDia === 7) return semana[0];
  return semana[1]
...
function mesesDelAño(array) {
 ...
 for (var i=0; i< array.length; i++){
   ...
   if (array[i]==='Marzo') meses.push(array[i]);
   if (array[i]==='Noviembre') meses.push(array[i]);
 }
