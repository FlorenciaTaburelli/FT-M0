...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
   /* por que no se puede usar la longitud
    if (numero.length===3){
        return(true)
    }
    else return(false)
...
function doWhile(numero) {
  ...
  var a = numero;
    ...
    do {
      i = i + 1; // cuenta las veces, las aumente de a uno
      a = a + 5; // aumenta de a 5 el numero entregado
    }
    while(i < 8); //cuando i llega a 8, se frena
    return(a);
}
